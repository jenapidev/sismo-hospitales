...
2. **SQL Editor** → run [`supabase/migrations/0001_init.sql`](supabase/migrations/0001_init.sql) then [`supabase/migrations/0002_seed_hospitals.sql`](supabase/migrations/0002_seed_hospitals.sql).
